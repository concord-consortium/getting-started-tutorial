...
# Create React GettingStartedTutorial Readme

This project was bootstrapped with [Create React GettingStartedTutorial](https://github.com/facebook/create-react-app).
...
You can learn more in the [Create React GettingStartedTutorial documentation](https://facebook.github.io/create-react-app/docs/getting-started).
